...
use janpan\jn\assets\froala_editor\FroalaEditorAsset;
use yii\helpers\Url;
...
class FroalaEditorWidget extends InputWidget {
    ...
    public function registerClientScript() {
        ...
        if ($themeType != 'default') {
            $view->registerCssFile("{$asset->baseUrl}/css/themes/{$themeType}.css", ['depends' => 'janpan\jn\assets\froala_editor\FroalaEditorAsset']);
        }
        //language
        ...
        if ($langType != 'es_gb') {
            ...
            $view->registerJsFile("{$asset->baseUrl}/js/languages/{$langType}.js", ['depends' => 'janpan\jn\assets\froala_editor\FroalaEditorAsset']);
        }
        $id = $this->options['id'];
