...
function renderTap(findTxt) {
    
    $('#conditionBox').html('<label><input type="checkbox" id="condition_auto" value="1" checked> Auto adding variable to Hide when specified Show or vice versa</label><ul id="conditionTabs" class="nav nav-tabs" role="tablist"></ul><div id="conditionTabContent" class="tab-content"></div>');
