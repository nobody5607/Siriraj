...
/*	    'access' => [
	...
	if (Yii::$app->getRequest()->isAjax) {
		...
		if ($model->save()) {
                    return \janpan\jn\classes\JResponse::getSuccess(Yii::t('app', 'Data completed.'), $model);
		} else {
                   // \appxq\sdii\utils\VarDumper::dump($model->errors);
                    return \janpan\jn\classes\JResponse::getError(Yii::t('app', 'Can not create the data.'), $model->errors);
